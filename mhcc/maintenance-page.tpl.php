...
<?php if (!$title) : ?>
<h1 class="art-headline" data-left="46.7%"><a href="<?php echo check_url($front_page); ?>" title = "<?php echo $site_name; ?>"><?php echo $site_name;  ?></a></h1><?php else : ?>
...
<h2 class="art-slogan" data-left="44.29%"><?php echo $site_slogan; ?>
</h2><?php endif; ?>
