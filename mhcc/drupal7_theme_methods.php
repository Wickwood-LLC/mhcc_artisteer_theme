...
$art_style = '';
$art_head = '';
function mhcc_process_html(&$variables) {
...
function mhcc_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function mhcc_button($variables) {
 ...
 */
function mhcc_preprocess_page(&$vars) {
  global $art_style, $art_head;
 ...
 * @ingroup themeable
 */
function mhcc_menu_local_task($variables) {
 ...
 */
function mhcc_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function mhcc_node_preview($variables) {
  $node = $variables['node'];
...
*/
function mhcc_form_alter(&$form, &$form_state, $form_id) {
...
function mhcc_form_element_label($variables) {
...
function mhcc_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
